...
<body>
    <div class="container">
        ...
        <a href="{{ route('jugador.store') }}" class="btn-primary">Ingresar jugador</a>
        <ul class="list-unstyled">
            @foreach ($jugador as $jugador)
                <li class="jugador-item">
                    <div class="jugador-info">
                        <a href="{{ route('jugador.show', $jugador->id) }}">{{ $jugador->nombre }}</a>
                    </div>
                    <div class="jugador-actions">
                        <a href="{{ route('jugador.edit', $jugador->id) }}" class="btn-warning">Editar</a>
