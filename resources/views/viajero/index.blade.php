...
<body>
    <div class="container">
        ...
        <a href="{{ route('viajero.store') }}" class="btn-primary">Ingresar nuevo viajero</a>
        <ul class="list-unstyled">
            @foreach ($viajero as $viajero)
                <li class="jugador-item">
                    <div class="jugador-info">
                        <a href="{{ route('viajero.show', $viajero->id) }}">{{ $viajero->nombre }}</a>
                    </div>
                    <div class="jugador-actions">
                        <a href="{{ route('viajero.edit', $viajero->id) }}" class="btn-warning">Editar</a>
