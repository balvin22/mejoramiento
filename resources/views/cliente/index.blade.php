...
<body>
    <div class="container">
        ...
        <a href="{{ route('cliente.store') }}" class="btn-primary">Ingresar cliente</a>
        <ul class="list-unstyled">
            @foreach ($cliente as $cliente)
                <li class="jugador-item">
                    <div class="jugador-info">
                        <a href="{{ route('cliente.show', $cliente->id) }}">{{ $cliente->codigo }}</a>
                    </div>
                    <div class="jugador-actions">
                        <a href="{{ route('cliente.edit', $cliente->id) }}" class="btn-warning">Editar</a>
