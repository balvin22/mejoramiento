...
<body>
    <div class="container">
        ...
        <a href="{{ route('destino.store') }}" class="btn-primary">Ingresar nuevo destino</a>
        <ul class="list-unstyled">
            @foreach ($destino as $destino)
                <li class="jugador-item">
                    <div class="jugador-info">
                        <a href="{{ route('destino.show', $destino->id) }}">{{ $destino->nombre }}</a>
                    </div>
                    <div class="jugador-actions">
                        <a href="{{ route('destino.edit', $vdestino->id) }}" class="btn-warning">Editar</a>
